...
class TestLlamaCppModel:
    ...
    def test_format_audio_content(self) -> None:
    ...
    def test_format_audio_content_default_format(self) -> None:
    ...
    def test_format_messages_with_audio(self) -> None:
    ...
    def test_format_messages_with_image(self) -> None:
